...
#define DHD_SCAN_ASSOC_ACTIVE_TIME	30 /* ms: Embedded default Active setting from DHD */
#define DHD_SCAN_UNASSOC_ACTIVE_TIME 60 /* ms: Embedded def. Unassoc Active setting from DHD */
